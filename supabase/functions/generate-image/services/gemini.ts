...
export const generateImage = async (
    ...
    if (requestType === 'edit') {
        systemInstruction += " You are provided with an ORIGINAL image (Image 1) and an ANNOTATION image (Image 2) which identifies target areas for modification using high-contrast overlays or labels. CRITICAL: You MUST strictly follow ALL annotations shown in Image 2. Each annotation (text label, shape, or marking) indicates a specific object or modification that MUST be implemented in the exact location shown. Your goal is to modify the ORIGINAL image according to the User Prompt and Design Parameters, strictly adhering to the locations and objects specified in the ANNOTATION image. Maintain the overall style and perspective of the original image unless instructed otherwise. IMPORTANT: The annotations in Image 2 are only logical guides and instructions; do not include or render any of the annotation markings themselves (like brush strokes, chips, or labels) in the final generated image - only implement what they indicate.";
    } else {
