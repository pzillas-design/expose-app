...
BEGIN
    ...
    -- GLOBAL OBJECTS (Overlapping fixes) - Temporarily disabled to ensure migration success
...
-- 3. Cleanup helper
DROP FUNCTION public.recreate_optimized_policy(text, text, text, text[], text);
