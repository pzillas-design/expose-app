...
export const SettingsModal: React.FC<SettingsModalProps> = ({
    ...
    initialTab, themeMode, onThemeChange, lang, onLangChange, onOpenAdmin, t
}) => {
                        ...
                        <div className="flex flex-col h-full items-center max-w-sm mx-auto">
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center w-full space-y-10">
                                ...
                                <div className="flex flex-col items-center gap-3">
                                    <div className="w-16 h-16 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center text-xl font-bold text-zinc-400 dark:text-zinc-600 shadow-inner">
                                        MP
                                    </div>
                                    <div className="text-center">
                                        <h2 className={`${Typo.H2} text-base`}>Michael Pzillas</h2>
                                        <p className={`${Typo.Body} text-zinc-400`}>pzillas@gmail.com</p>
                                    </div>
                                </div>
