 ...
 */
export function formatRelativeTime(date: Date | string, lang: 'de' | 'en' = 'de'): string {
 ...
 */
export function daysUntilBoardDeletion(lastActivityAt: Date | string): number {
 ...
 */
export function shouldShowDeletionCountdown(lastActivityAt: Date | string): boolean {
