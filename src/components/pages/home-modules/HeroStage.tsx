...
export const HeroStage: React.FC<HeroStageProps> = ({ progress, scrollActive }) => {
    ...
    const floatingImagesV1 = [
        ...
        { src: '/home/1 creation reimagined/1.jpeg', x: '8%', y: '40%', depth: -1200, size: '22vw' },    // swapped from pos 8
        ...
        { src: '/home/1 creation reimagined/8.jpeg', x: '88%', y: '82%', depth: -400, size: '28vw' },    // swapped from pos 1
