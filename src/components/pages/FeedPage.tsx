        ...
        >
            ...
            <div className="relative isolate" style={boundedStyle}>
                ...
                {isGroup && !isGen && galleryStyle === 'masonry-flat' && (
                    <>
                        {groupCount > 2 && <div className="absolute inset-x-[10px] -bottom-[10px] h-full -z-20 shadow-sm ring-1 ring-black/5 dark:ring-white/10 bg-zinc-300 dark:bg-zinc-700" />}
                        <div className="absolute inset-x-[5px] -bottom-[5px] h-full -z-10 shadow-sm ring-1 ring-black/5 dark:ring-white/10 bg-zinc-200 dark:bg-zinc-800" />
                    </>
                )}
