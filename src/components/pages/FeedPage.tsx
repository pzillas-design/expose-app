        ...
        >
            ...
            <div className="relative isolate" style={boundedStyle}>
                ...
                {isGroup && !isGen && galleryStyle === 'masonry-flat' && (
                    <>
                        {groupCount > 2 && <div className="absolute inset-x-[10px] -bottom-[10px] h-full -z-20 shadow-sm ring-1 ring-black/5 dark:ring-white/10 bg-zinc-300 dark:bg-zinc-700" style={stackColor ? { backgroundColor: stackColor, opacity: 0.55 } : undefined} />}
                        <div
