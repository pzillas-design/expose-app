...
const ProgressionGrid = ({ depth }: { depth: number }) => {
    ...
    return (
        <div
            className="flex flex-wrap justify-center gap-4 w-full max-w-7xl px-10"
...
export const AboutPage: React.FC<AboutPageProps> = ({ user, userProfile, credits, onCreateBoard, t }) => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            setScrollDepth(scrolled * 0.8); // Increased sensitivity
        };
    ...
    return (
        <div className="bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 min-h-[1000vh] flex flex-col selection:bg-orange-500 selection:text-white overflow-x-hidden">
            ...
            <main className="fixed inset-0 overflow-hidden pointer-events-none">
                ...
                >
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6" style={{ transform: 'translateZ(200px)' }}>
                        ...
                        <p className="max-w-md mx-auto text-xl text-zinc-500 font-medium tracking-tight">
                    ...
                    {/* Layer 2: Iterativ & Parallel */}
                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none" style={{ transform: 'translateZ(-3000px)' }}>
                        <div className="max-w-4xl p-6 text-center mb-32 pointer-events-auto">
                    ...
                    {/* Layer 3: Precision Control */}
                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none" style={{ transform: 'translateZ(-7000px)' }}>
                        <div className="max-w-5xl p-10 flex flex-col items-center pointer-events-auto">
                            <h2 className="text-8xl font-bold mb-12 tracking-tight">Präzise Steuerung.</h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center text-center md:text-left">
                                ...
                                <div className="w-64 h-64 mx-auto bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl flex items-center justify-center relative overflow-hidden group">
                                    <div className="absolute inset-6 border-2 border-dashed border-orange-500/20 group-hover:border-orange-500/40 transition-colors" />
                                    <div className="text-[10px] font-mono tracking-widest text-zinc-400">INTERFACE_CORE</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Layer 4: Final Quote */}
                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none" style={{ transform: 'translateZ(-11000px)' }}>
                        <div className="max-w-6xl p-6 text-center pointer-events-auto">
