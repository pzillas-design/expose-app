        ...
        <div className="bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 min-h-screen flex flex-col">
            ...
            <main className="flex-1 w-full max-w-3xl mx-auto px-6 pt-12 sm:pt-44 pb-12 sm:pb-24">
                <article className="prose prose-zinc dark:prose-invert max-w-none prose-p:leading-7 prose-p:mb-5 prose-h1:mb-8">
                    ...
                    <h3 className={h3Class}>Angaben gemäß § 5 DDG</h3>
                    <p>
                        Michael Pzillas<br />
                        Lahnstraße 96<br />
                    ...
                    <h3 className={h3Class}>Kontakt</h3>
                    <p>
                        E-Mail:{' '}
                    ...
                    <h3 className={h3Class}>Umsatzsteuer-ID</h3>
                    <p>
                        Umsatzsteuer-Identifikationsnummer gemäß § 27 a Umsatzsteuergesetz:<br />
                        DE366389646
                    </p>

                    <h3 className={h3Class}>Streitschlichtung</h3>
                    <p>
                    ...
                    <h2 className={h2Class}>Datenschutzerklärung</h2>
                    ...
                    <h3 className={h3Class}>2. Hosting und Content Delivery Networks (CDN)</h3>
                    <p>
                        Wir hosten die Inhalte unserer Website bei folgenden Anbietern:
                    </p>
                    <h4 className={h4Class}>Vercel</h4>
                    <p>
                    ...
                    <h4 className={h4Class}>Vercel Analytics und Speed Insights</h4>
                    <p>
                    ...
                    <h3 className={h3Class}>4. Welche Daten wir verarbeiten</h3>
                    <p>
                    ...
                    <h3 className={h3Class}>5. Zwecke und Rechtsgrundlagen der Verarbeitung</h3>
                    <p>
                    ...
                    <h3 className={h3Class}>6. Eingesetzte Dienstleister</h3>
                    <h4 className={h4Class}>Supabase</h4>
                    <p>
                    ...
                    <h4 className={h4Class}>Google</h4>
                    <p>
                    ...
                    <h4 className={h4Class}>Stripe</h4>
                    <p>
                    ...
                    <h4 className={h4Class}>Google Login</h4>
                    <p>
                    ...
                    <h3 className={h3Class}>9. Ihre Rechte</h3>
                    <p>
                    ...
                    <h3 className={h3Class}>10. Kontakt in Datenschutzfragen</h3>
                    <p>
                    ...
                    <h2 className={h2Class}>Allgemeine Geschäftsbedingungen (AGB)</h2>

                    <h3 className={h3Class}>1. Geltungsbereich</h3>
                    <p>
                    ...
                    <h3 className={h3Class}>2. Vertragsgegenstand und Leistungen</h3>
                    <p>
                    ...
                    <h3 className={h3Class}>3. Registrierung und Account</h3>
                    <p>
                    ...
                    <h3 className={h3Class}>4. Credits und Zahlungsbedingungen</h3>
                    <p>
                    ...
                    <h3 className={h3Class}>7. Pflichten des Nutzers</h3>
                    <p>
                    ...
                    <h3 className={h3Class}>8. KI-typische Einschränkungen</h3>
                    <p>
                    ...
                    <h3 className={h3Class}>9. Haftung und Gewährleistung</h3>
                    <p>
                    ...
                    <h3 className={h3Class}>10. Widerrufsbelehrung</h3>
                    <p>
                    ...
                    <h3 className={h3Class}>11. Schlussbestimmungen</h3>
                    <p>
