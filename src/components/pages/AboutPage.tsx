        ...
        <div className="w-full max-w-sm mx-auto bg-white dark:bg-zinc-950 rounded-2xl border border-zinc-200 dark:border-zinc-900 shadow-2xl overflow-hidden flex flex-col animate-in fade-in zoom-in duration-700">
            ...
            <div className="p-6 flex flex-col gap-4">
                ...
                <div className="p-4 rounded-xl border border-zinc-100 dark:border-zinc-900 flex flex-col gap-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {['Sommer', 'Herbst', 'Winter', 'Frühling'].map(s => (
                            <button key={s} onClick={() => setSelectedSeason(s)} className={`px-3 py-1.5 rounded-md text-[11px] transition-all ${selectedSeason === s ? 'bg-zinc-900 dark:bg-white text-white dark:text-black font-bold' : 'bg-zinc-100 dark:bg-zinc-900 text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300'}`}>{s}</button>
                        ))}
                    </div>
                </div>
                <div className="p-4 rounded-xl border border-zinc-100 dark:border-zinc-900 flex flex-col gap-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {['Mittag', 'Nachmittag', 'Golden Hour', 'Blue Hour', 'Nacht'].map(t => (
                            <button key={t} onClick={() => setSelectedTime(t)} className={`px-3 py-1.5 rounded-md text-[11px] transition-all ${selectedTime === t ? 'bg-zinc-900 dark:bg-white text-white dark:text-black font-bold' : 'bg-zinc-100 dark:bg-zinc-900 text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300'}`}>{t}</button>
                        ))}
                    </div>
                </div>
                ...
                <button className="w-full py-4 rounded-xl bg-zinc-900 dark:bg-white text-white dark:text-black font-bold text-sm tracking-tight mt-4 flex items-center justify-center gap-2 group overflow-hidden relative">
                    <span className="relative z-10 uppercase">Generieren</span>
    ...
    return (
        <div className="bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 min-h-screen flex flex-col selection:bg-orange-500 selection:text-white overflow-x-hidden">
            ...
            <main className="flex-1 w-full">
                ...
                {/* Content Section: Iterativ + Parallel */}
                <section className="relative min-h-screen py-32 flex flex-col items-center justify-center bg-white dark:bg-zinc-950 overflow-hidden">
                    <div className="max-w-[1700px] mx-auto w-full flex flex-col lg:row items-center relative z-10 px-6">
                        <div className="w-auto order-2 lg:order-1 flex-none">
                            <CanvasMockup />
                        </div>
                        <div className="flex-1 order-1 lg:order-2 px-6 lg:px-20 xl:px-40 flex flex-col justify-center mb-16 lg:mb-0">
                ...
                {/* Content Section: Präzise Steuerung */}
                ...
                {/* Content Section: Visual Prompting */}
                <section className="relative min-h-screen py-32 flex flex-col items-center justify-center bg-white dark:bg-zinc-950 overflow-hidden">
                    ...
                    <div className="w-full max-w-5xl px-6 relative group mb-32">
