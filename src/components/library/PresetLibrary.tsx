...
export const PresetLibrary: React.FC<PresetLibraryProps> = ({
    ...
    const pinnedTemplates = useMemo(() => languageFilteredTemplates.filter(t => t.isPinned), [languageFilteredTemplates]);
                ...
                <div className="flex flex-col">
                    ...
                    {isSearchActive ? (
                        ...
                        <>
                            {/* PRESETS SECTION */}
                            <div className="flex flex-col">
                                <div className={`flex items-center justify-between px-3 py-3 border-t ${Theme.Colors.Border} hover:bg-zinc-50 dark:hover:bg-zinc-800/10 transition-colors group`}>
                                    <button
                            ...
                            <div className="flex flex-col">
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-3 py-3 border-t ${Theme.Colors.Border} hover:bg-zinc-50 dark:hover:bg-zinc-800/10 transition-colors`}
                                >
