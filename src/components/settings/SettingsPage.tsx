                            ...
                            <div className="relative group">
                                ...
                                {isQualityDropdownOpen && (
                                    <>
                                        ...
                                        <div className="absolute top-full left-0 right-0 mt-2 p-1.5 bg-white dark:bg-zinc-900 border border-zinc-200/50 dark:border-white/5 rounded-xl shadow-xl flex flex-col gap-1 animate-in fade-in slide-in-from-top-2 duration-200 z-50 ring-1 ring-zinc-900/5 dark:ring-white/5 text-left">
                                            {MODES.map((m) => (
                                                <button
                                                    key={m.id}
                                ...
                                <div className="relative group">
                                    ...
                                    {isAppearanceDropdownOpen && (
                                        <>
                                            ...
                                            <div className="absolute top-full left-0 right-0 mt-2 p-1.5 bg-white dark:bg-zinc-800 border border-zinc-200/50 dark:border-white/10 rounded-xl shadow-xl flex flex-col gap-1 animate-in fade-in slide-in-from-top-2 duration-200 z-50 ring-1 ring-zinc-900/5 dark:ring-white/5 text-left">
                                                {THEMES.map((t_item) => (
                                                    <button
                                                        key={t_item.id}
                                                        onClick={() => { onThemeChange(t_item.id as any); setIsAppearanceDropdownOpen(false); }}
                                                        className={`flex items-center justify-between p-3 rounded-lg transition-all ${themeMode === t_item.id ? 'bg-zinc-50 dark:bg-white/10' : 'hover:bg-zinc-50 dark:hover:bg-white/5'}`}
                                                    >
                                            ...
                                            <div className="absolute top-full left-0 right-0 mt-2 p-1.5 bg-white dark:bg-zinc-800 border border-zinc-200/50 dark:border-white/10 rounded-xl shadow-xl flex flex-col gap-1 animate-in fade-in slide-in-from-top-2 duration-200 z-50 ring-1 ring-zinc-900/5 dark:ring-white/5 text-left">
                                                {LANGUAGES.map((l_item) => (
                                                    <button
                                                        ...
                                                        className={`flex items-center justify-between p-3 rounded-lg transition-all ${lang === l_item.id ? 'bg-zinc-50 dark:bg-white/10' : 'hover:bg-zinc-50 dark:hover:bg-white/5'}`}
                                                    >
