...
export const Button: React.FC<ButtonProps> = ({
    ...
    const variants = {
        ...
        secondary: `${Theme.Colors.Surface} border ${Theme.Colors.Border} ${Theme.Colors.TextPrimary} ${Theme.Colors.SurfaceHover} hover:border-zinc-300 dark:hover:border-zinc-600 py-2.5 ${Typo.Body} font-medium`,
