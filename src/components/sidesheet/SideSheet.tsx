            ...
            >
                ...
                <div className="flex-1 flex flex-col p-6 gap-12 items-center justify-center">
                    ...
                    <div className="flex flex-col items-center text-center gap-8">
                        <div className={`w-28 h-28 flex items-center justify-center rounded-3xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800/50 transition-transform duration-700`}>
