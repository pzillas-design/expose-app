                                ...
                                <div className="flex flex-col gap-4 pt-6">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <IconButton
                                            ...
                                            className="!rounded-lg border border-zinc-200 dark:border-white/5 bg-zinc-100 dark:bg-zinc-800/50 text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-200 transition-colors"
                                        />
                                    </div>
                                </div>
                            </div>
