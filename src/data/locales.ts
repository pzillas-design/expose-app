...
export const translations = {
  en: {
    ...
    error_server_busy: "AI is busy — Please wait a moment",
    ...
    home_editorial_kicker: "image engine",
    home_editorial_title: "powered by googles nano banana 2, dem besten ki-bildmodell.",
    home_editorial_desc: "Build faster with an image model that stays sharp across variations, edits, and side-by-side decisions.",
    home_editorial_card_kicker: "why exposé",
    home_editorial_card_one_title: "compare in context",
    home_editorial_card_one_desc: "Lay out multiple directions at once and judge them as a set instead of one image at a time.",
    home_editorial_card_two_title: "edit with intent",
    home_editorial_card_two_desc: "Move from prompt to precise visual feedback without breaking the flow of a real creative review.",
  ...
  de: {
    ...
    error_server_busy: "KI gerade überlastet – Bitte kurz warten",
    ...
    home_editorial_kicker: "bild-engine",
    home_editorial_title: "powered by googles nano banana 2, dem besten ki-bildmodell.",
    home_editorial_desc: "Ein Bildmodell, das auch bei Varianten, Edits und echten Auswahlentscheidungen scharf und konsistent bleibt.",
    home_editorial_card_kicker: "warum exposé",
    home_editorial_card_one_title: "im kontext vergleichen",
    home_editorial_card_one_desc: "Mehrere Richtungen gleichzeitig sehen und als Strecke bewerten statt Bild für Bild.",
    home_editorial_card_two_title: "gezielt verfeinern",
    home_editorial_card_two_desc: "Vom Prompt zu präzisem visuellem Feedback, ohne den kreativen Flow zu unterbrechen.",
