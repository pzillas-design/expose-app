...
export const translations = {
  en: {
    ...
    home_section_templates_title: "Build & reuse templates",
    home_section_templates_desc: "Define your look once and apply it across projects — for consistent results every time.",
